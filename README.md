...
- **shot** sends a picture of your screen when you press your key. It stays in the conversation and rides along with every later answer until wngmn quits. Whatever else is on the screen goes with it, so drag a region if that matters. The file is deleted as soon as it's read.
